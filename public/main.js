...
// function clearSceneLights(scene) { // *
...
//         texture.wrapS = THREE.RepeatWrapping;
//         texture.wrapT = THREE.RepeatWrapping;
//         texture.repeat.set(8, 8); // Tile 4 times across the plane
//     });
...
//     planeMaterial.displacementScale = 2;
...
if (currentLevel == 2) {
    ...
    const gltfLoader = new GLTFLoader();
    gltfLoader.load('./assets/level3/cgv-heaven-map-baked-mesh.glb', (gltf) => {
        // Add the loaded infernoMap to the scene
        infernoMap = gltf.scene;
